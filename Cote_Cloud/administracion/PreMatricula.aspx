    ...
    <asp:UpdatePanel ID="updating" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <asp:Panel runat="server" ID="pnlIniciarNuevoProceso" Visible="true">
                                                            ...
                                                            <div class="dataTables_wrapper">
                                                                <div class="dt-buttons">
                                                                    <asp:Button ID="btnReportEstudiantes" runat="server" Text="Reporte" CssClass="dt-button buttons-copy buttons-html5"
                                                                        OnClick="btnReportEstudiantes_Click" /><a href="adminEditStudents.aspx" target="_blank" class="dt-button buttons-copy buttons-html5">Editar datos estudiantes</a>
                                                                </div>
                                                                            ...
                                                                            <div class="table-responsive m-t-40">
                                                                                <div class="dataTables_wrapper">
                                                                                    <div class="dt-buttons">
                                                                                        ...
                                                                                        <asp:Button ID="btnNotifyStudens" runat="server" Text="Notificar admitidos" CssClass="dt-button buttons-copy buttons-html5"
                                                                                            OnClick="btnNotifyStudens_Click" />
                                                                                        <asp:Button ID="btnFormsMatricula" runat="server" Text="Matricula" CssClass="dt-button buttons-copy buttons-html5"
                                                                                            OnClick="btnFormsMatricula_Click" />
                                                                                    </div>
                                                                                    <div id="example23_filter" class="dataTables_filter">
                                                                                        <label>
                                                                                ...
                                                                                table-striped table-bordered dataTable"
                                                                                        ...
                                                                                        OnRowDeleting="gvEditAdmitidos_RowDeleting" PagerStyle-BorderColor="#cccccc" PagerStyle-BorderStyle="Solid" PagerStyle-BorderWidth="0.5px" PagerStyle-Font-Size="Large" OnRowCommand="gvEditAdmitidos_RowCommand">
                                                                                        <EmptyDataTemplate>
                                                                                            <div class="alert alert-secondary">
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:ButtonField ControlStyle-CssClass="btn btn-facebook" CommandName="notify" Text="Notificar estudiante"/>
                                                                                            <asp:ButtonField ControlStyle-CssClass="btn btn-facebook" CommandName="matricula" Text="Matrícula estudiante" />
                                                                                        </Columns>
                                                                                        <RowStyle CssClass="odd" />
                                                                                        <PagerSettings Mode="Numeric" PageButtonCount="6" />
                                                                                    </asp:GridView>
